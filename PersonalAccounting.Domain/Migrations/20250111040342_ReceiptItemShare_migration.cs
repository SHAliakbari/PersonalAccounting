...
{
    /// <inheritdoc />
    public partial class ReceiptItemShare_migration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ReceiptItemShares",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReceiptItemShares", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReceiptItemShares_ReceiptItems_ReceiptItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceiptItemShares_ReceiptItemId",
                table: "ReceiptItemShares",
